...
libdnstd.a: DNode.o DList.o DTree.o Binary.o Character.o Complex.o DArray.o DavidException.o DHashMap.o Double.o DRandom.o DStack.o DString.o StringTokenizer.o NumericalIntegration.o fft.o
	ar rcs $@ $^
